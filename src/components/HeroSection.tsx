    ...
    <section className="min-h-screen bg-slate-900 flex items-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-24 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              ...
              className="flex-1 sm:flex-none inline-flex items-center justify-center px-8 py-4 bg-white text-slate-900 font-bold text-sm tracking-wider hover:bg-[#d4af37] hover:text-white transition-colors"
            >
              無料で学ぶ（Day 1〜）
            </Link>
            <Link
              ...
              className="flex-1 sm:flex-none inline-flex items-center justify-center px-8 py-4 border-2 border-[#d4af37] text-[#d4af37] font-bold text-sm tracking-wider hover:bg-[#d4af37] hover:text-slate-900 transition-colors"
            >
              プロに任せる（無料相談）
            </Link>
          </div>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl">
          <div className="border border-slate-700 p-6 hover:border-[#d4af37] transition-colors group">
            <p className="text-[#d4af37] text-xs font-bold tracking-widest uppercase mb-3">Option 01</p>
            <h3 className="text-white font-bold text-xl mb-2">自分でAIを学ぶ</h3>
          ...
          <div className="border border-[#d4af37] p-6 bg-[#d4af37]/5 group">
            <p className="text-[#d4af37] text-xs font-bold tracking-widest uppercase mb-3">Option 02</p>
            <h3 className="text-white font-bold text-xl mb-2">プロに丸投げする</h3>
